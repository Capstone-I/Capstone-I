...
prediction_df_2018.sort_values(by='wins_2018', ascending=False, inplace=True)
...
plt.title(f'Actual vs Predicted Wins for 2018 Season (HQNN QFT)')
plt.legend()
...
# Save to CSV
prediction_df_2018.to_csv('~/Desktop/nba-games/nba_data_2018_prediction_HQNN_QFT.csv', index=False)